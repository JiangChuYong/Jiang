...
{
    if (!maxDate) return NO;
    
    return [self compare:maxDate] == NSOrderedAscending;
}
/**  minDate小于self*/
-(BOOL)minCompareDate:(NSDate *)minDate
{
    if (!minDate) return NO;
    
    return [self compare:minDate] == NSOrderedDescending;
}
/**  date等于self*/
